...
def test_tiny_acted_together():
    expected = True
    result = lab.acted_together(db_tiny, 2876, 1532)
...
# my own test cases here
def test_tiny_bacon_number_0():
    expected = {4724}
    actual = lab.actors_with_bacon_number(db_tiny, 0)
    assert actual == expected 
def test_tiny_bacon_number_1():
    expected = {2876, 1532}
    actual = lab.actors_with_bacon_number(db_tiny, 1)
    assert actual == expected
def test_tiny_bacon_number_2():
    expected = {1640}
    actual = lab.actors_with_bacon_number(db_tiny, 2)
    assert actual == expected 
def test_tiny_bacon_number_3():
    expected = set()
    actual = lab.actors_with_bacon_number(db_tiny, 3)
    assert actual == expected
...
# my actor_to_actor test case

def test_tiny_actor_to_actor_path():
    result = lab.actor_to_actor_path(db_tiny, 1532, 1640)
    print(result)
